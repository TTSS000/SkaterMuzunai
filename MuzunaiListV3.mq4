...
enum ENUM_SYMBOLS {
  AUDJPY, AUDUSD, CHFJPY,  EURAUD, EURCAD, EURGBP, EURJPY, EURUSD, GBPAUD, GBPJPY, GBPUSD, NZDJPY, NZDUSD
      , USDCAD, USDCHF, USDJPY, XAUUSD
};
string str_symbols[] = {"AUDJPY", "AUDUSD", "CHFJPY", "EURAUD", "EURCAD", "EURGBP", "EURJPY"
